...
void setup() {
	...
	outputBypassPinList[0] = PIN_SOLENOID_1;		// OUT A1
	outputBypassPinList[1] = PIN_SOLENOID_2;		// OUT A2
	outputBypassPinList[2] = PIN_SOLENOID_3;		// OUT A3
	outputBypassPinList[3] = PIN_DROP_MBALL;		// OUT B4
	outputBypassPinList[4] = PIN_HEATING_MBALL;			// HP OUT
	outputBypassPinList[5] = PIN_EGG_BREAKER;		// OUT A4
	outputBypassPinList[6] = PIN_HOT_WATER;			// OUT B1
